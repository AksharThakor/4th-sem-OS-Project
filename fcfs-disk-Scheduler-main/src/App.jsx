...
import "./App.css";
import DiskSimulator from './components/simulator';
// MUI
...
return (
	...
	<div className="App">
		{/* Render the DiskSimulator component, passing in the setData function as a prop */}
		<DiskSimulator setData={setData} />
	</div>
</ThemeProvider>
);
};
